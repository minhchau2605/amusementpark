...
foreach($places as $place)
{
	foreach($placeList as $placeRow)
	{
		if($placeRow['zone_id']==$place)
		{
			...
			//print_r($placeRow);
			//$xp->assign('CONFIRMPLACE.no',$placeRow['no']);
			//$xp->assign('CONFIRMPLACE.zone_name',$placeRow['zone_name']);
			//$xp->assign('CONFIRMPLACE.total_adult_price',$placeRow['total_adult_price']);
			//$xp->assign('CONFIRMPLACE.total_children_price',$placeRow['total_children_price']);
			
			//$xp->parse('TICKET.CONFIRMPLACE');
